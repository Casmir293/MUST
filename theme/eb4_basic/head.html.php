                ...
                <div class="container">
                    <div class="row align-items-center position-relative">
                        ...
                        <div class="col-lg-6 clearfix">
                            <ul class="top-header-nav list-unstyled thn-end  d-lg-flex align-items-center">
                                <?php if ($is_member) {  ?>
                                    <?php if ($is_admin) {  ?>
                                ...
                                <li class="header-title-search d-none d-lg-block">
                    ...
                    <a href="<?php echo G5_URL; ?>" class="title-logo">
                        ...
                        <?php } else if ($logo == 'image') { ?>
                            <?php if (!G5_IS_MOBILE) { ?>
                                ...
                                <?php } else { ?>
                                    <img src="<?php echo EYOOM_THEME_URL; ?>/image/site_logo.png" class="site-logo" alt="<?php echo $config['cf_title']; ?>">
                                <?php } ?>
                            <?php } else { ?>
